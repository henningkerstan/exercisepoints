...
%%
%% Copyright (c) 2017-2018 Henning Kerstan
%
...
\begin{description}
\item[\packageversion] Renamed the package from \emph{hkexercise} to \emph{exercisepoints} to comply with CTAN rules (see \url{https://ctan.org/file/help/ctan/CTAN-upload-addendum})
